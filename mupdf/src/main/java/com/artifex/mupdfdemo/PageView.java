...
public abstract class PageView extends ViewGroup {
	...
	public void releaseResources() {
		...
		Broadcast.postEvent(new HideLoadingEvent());
	}
	...
	public void blank(int page) {
		...
		Broadcast.postEvent(new ShowLoadingEvent());
	...
	public void setPage(final int page, PointF size) {
		...
		/* this caused some crashes in the app, but we don't need the links anyway) */
...
//		mGetLinkInfo.execute();
		...
		//TODO this is a hack, but it works as long as pdfs can only be opened by the first page
		if(page != 0) {
			Broadcast.postEvent(new HideLoadingEvent());
		}
	}
	...
	public static class ShowLoadingEvent implements Serializable {}
	public static class HideLoadingEvent implements Serializable {}
}
